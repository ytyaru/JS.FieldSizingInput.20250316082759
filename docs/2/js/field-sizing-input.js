class FieldSizingInput extends HTMLElement {
    constructor() {
        ...
        this._options = {
            font: {
//                family: `uzu-fude`, // monospace Ricty 衡山毛筆フォント行書 渦筆
//                family: 'KouzanBrushFontGyousyoOTF',
//                family: 'AnkokuZombic',
                family: '暗黒ゾン字',
                size: `16px`,
            }
    ...
    /*
@font-face {
  font-family: "AnkokuZombic";
  src:
    local("暗黒ゾン字"),
    local("AnkokuZombic"),
    url("/home/pi/.fonts/Zomzi.TTF") format("ttf");
}
@font-face {
  font-family: "my-font";
  src:
    local("${this._options.font.family}"),
    url("monoscape.otf") format("opentype") tech(color-COLRv1),
    url("monoscape.otf") format("opentype"),
    url("monoscape.woff") format("woff");
}
*/
    #makeStyle(shadow) {
...
input {
    /*
    font-family: 'AnkokuZombic', '暗黒ゾン字', 'my-font', monoscape;
    font-size: 16px;
    */
    /*
    font-family: ${this._options.font.family};
    font-size: ${this._options.font.family};
    */
    position: absolute;
    top: 0;
    left: 0;
...
`);
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        ...
        */
        ...
        //else if ('placeholder'===name) {this.style.fontFamily=newValue}
        else if ('placeholder'===name) {this.placeholder=newValue}
        else if ('font-size'===name) {this.style.fontSize=newValue}
        //else if ('fontFamily'===name) {this.style.fontFamily=newValue}
    ...
    set mode(v) {
        if (FieldSizingInput.Modes.includes(v)) {
...
//customElements.define('edit-or-view', FieldSizingInput, {extends:'textarea'});
